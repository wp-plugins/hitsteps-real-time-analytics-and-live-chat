<?php
/*
Plugin Name: Hitsteps Blog Analytics & Live Chat
Plugin URI: http://www.hitsteps.com/
Description: Hitsteps is a free powerful real time website visitor manager, it allow you to view and interact with your visitors in real time.
Author: hitsteps
Version: 1.00
...
?><!-- HITSTEPS TRACKING CODE<?php echo $htssl; ?> sv1.00 - DO NOT CHANGE --><?php
...
$postaction='';
	...
	if ( $option['code']=='' && $postaction!='do' && $_REQUEST['hitmagic']!='do' ) {
		function hitsteps_warning() {
			echo "
			<div id='hitsteps-warning' class='updated fade'><p><strong>".__('hitsteps is almost ready.')."</strong> ".sprintf(__('You must <a href="%1$s">enter your hitsteps API key</a> to start tracking your stats.'), "options-general.php?page=hitsteps-real-time-analytics-and-live-chat/hitsteps.php")."</p></div>
			";
...
<!-- HITSTEPS ONLINE SUPPORT CODE sv1.00 - DO NOT CHANGE --><div id="hs-live-chat-pos"><script type="text/javascript">
...
add_action('widgets_init', create_function('', 'return register_widget("hst_STATS");'));
	...
	function hitsteps_settingsLink($actionLinks, $file) {
 		if (($file == 'hitsteps-real-time-analytics-and-live-chat/hitsteps.php') && function_exists('admin_url')) {
			$settingsLink = '<a href="' . admin_url('options-general.php?page=hitsteps-real-time-analytics-and-live-chat/hitsteps.php') . '">' . __('Settings') . '</a>';
